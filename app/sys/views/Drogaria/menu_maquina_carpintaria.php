...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#submeter_pagamento_maquina").on("click",function(){
			...
			if(nome_cliente==""){				
				...
				$.post("",{want:"drogaria",data:"pagamento_minuto","dados":dados},function(resp){
		...
		$("#persquisar_pagamento_maquina").on("click",function(){
			...
			$.post("",{want:"drogaria",data:"persquisar_pagamento_maquina","data_pesquisa":data_pesquisa},function(resp){
	...
	//});
		...
		$("#maquina_mensal").on("click",function(){
			$("#area_pesquisa").html("");
			$("#myTabContent").html("");
			$.post("",{want:"drogaria",data:"pagamento_maquina_do_mes"},function(resp){
				$("#myTabContent").html(resp);
			});

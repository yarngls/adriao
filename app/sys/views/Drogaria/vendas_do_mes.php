<?php
	...
	$data_da_venda_carregada=$_SESSION['mes_ano_venda_actual'];
	$array_da_venda_do_mes=$_SESSION['array_venda_mes_actual'];
	$numero_dias_vendas=$_SESSION['dias_vendas'];
...
<form class="form-horizontal">
	...
	<table>
		<tr>
			<td>
				<select class="form-control" id="mes_pesquisar_venda">
				<?php 
			...
			<td>
				<select class="form-control" id="ano_pesquisar_venda">
				<?php
			...
			<td>
				<button style="width:2vw;" type="button" id="persquisar_venda_mes" class="btn btn-w-m btn-primary"  data-toggle="modal" data-target="#myModalListarFolhas"><i class="fa fa-check"></i></button></li>
			</td>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#persquisar_venda_mes").on("click",function(){

			var mes_pesquisar_venda = $("#mes_pesquisar_venda").val();
			var ind_mes_pesquisar_venda = returnIndeceMes(mes_pesquisar_venda);
			var ano_pesquisar_venda = $("#ano_pesquisar_venda").val();
			var dados={"ind_mes_pesquisar_venda":ind_mes_pesquisar_venda,"ano_pesquisar_venda":ano_pesquisar_venda};
			
			$.post("",{want:"drogaria",data:"persquisar_venda_mes_data","dados":dados},function(resp){				
				$("#myTabContentVendas").html(resp);
			});

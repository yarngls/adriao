<?php
  $dados_stock_madeira=$_SESSION['dados_stock_madeira'];
...
?>
      ...
      <?php
              ...
              ?>
        <h3 style="margin-left:30vw;"> Total em Stock: $00</h3>
          <table class="table table-striped table-bordered table-hover dataTables-example" style="font-size: 12; margin-top:2vh;" >
              ...
              <?php
                for($i=0;$i<count($dados_stock_madeira);$i++){
                        //$total = $dados_rec[$i]['preco_venda'] * $dados_rec[$i]['quantidade'];
              ?>
                 <tr class="gradeC">
                    <td><?php echo $dados_stock_madeira[$i]['numero_registo'] ?></td>
                    <td><?php echo $dados_stock_madeira[$i]['categoria_madeira'] ?></td>
                    <td><?php echo $dados_stock_madeira[$i]['comprimento_madeira'] ?></td>
                    <td><?php echo $dados_stock_madeira[$i]['espessura_madeira'] ?></td>
                    <td><?php echo $dados_stock_madeira[$i]['largura_madeira'] ?></td>
                    <td><?php echo $dados_stock_madeira[$i]['cubagem_madeira'] ?></td>
                    <td><?php echo ceil($dados_stock_madeira[$i]['preco_unitario']) ?></td>
                    <td><?php echo $dados_stock_madeira[$i]['data_registo'] ?></td>

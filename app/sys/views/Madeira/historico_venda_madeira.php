...
<form class="form-horizontal">
    ...
    <button class="btn btn-outline btn-primary " style="margin-left:70vw;" type="button" data-toggle="modal" data-target="#myModal-venda-madeira">Nova Venda Madeira</button>
    ...
    <table>
				<tbody>
					<h1 style="margin-left:25vw;">Venda de Madeira</h1>
					<tr>
						<td>
    ...
    <div id="myTabContent" class="tab-content" style="margin-top:4vh;">
    	...
    	<h3 style="margin-left:30vw;"> Total da Venda: $00</h3>
	...
	<!--------------------------------- inicio modal venda madeira ---------------------------------------->  

    <div class="modal fade" id="myModal-venda-madeira" style="margin-left:16vw;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  <div class="modal-dialog" style="width:65vw; align:center;">
		    <div class="modal-content">
		      ...
		      <div class="modal-body" id='myModal-venda-madeira-body'>
		      ...
		      <div class="modal-footer" id='myModal-venda-madeira-footer'>
